(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_photoeditorsdk_esm_ui_colorPicker_index_js"],{
...
/* harmony export */   "Color": () => /* binding */ m,
/* harmony export */   "ColorPicker": () => /* binding */ _
/* harmony export */ });
...
`;var Q=Re;const He=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  ...
  width: 28px;
  padding-left: 4px;
`,Pe=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__.default)(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Text)`
  input {
    text-align: center;
    border-bottom: 1px solid
      ${e=>e.theme.colorPicker.inputBorderColor};
  }
`,$e=({value:e,label:r,onChange:t})=>react__WEBPACK_IMPORTED_MODULE_2__.createElement(He,null,react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Label,{label:r}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Pe,{min:0,max:255,value:e,onChange:t}));var F=$e;const Me=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  text-align: left;
  width: 62px;
`,Te=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__.default)(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Text)`
  input {
    text-align: left;
    border-bottom: 1px solid
      ${e=>e.theme.colorPicker.inputBorderColor};
  }
`,Be=({value:e,label:r,onChange:t})=>react__WEBPACK_IMPORTED_MODULE_2__.createElement(Me,null,react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Label,{label:r}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Te,{value:e.toUpperCase(),onChange:t}));var re=Be;const oe=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div.attrs(e=>({style:{left:e.position.x||`${0}px`,top:e.position.y||`${0}px`}}))`
  &&& {
    position: absolute;
...
`;var H=oe;oe.defaultProps={theme:_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.v};const ne=(0,_chunk_IQZ6RVTD_js__WEBPACK_IMPORTED_MODULE_1__.U)((0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.Y)());const De=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  position: relative;
  height: 14px;
  width: 100%;
`;class ie extends react__WEBPACK_IMPORTED_MODULE_2__.Component{constructor(e){super(e);this.onDragStart=e=>{this.setState({dragging:!0}),this.onPositionChange(e)};this.onPositionChange=e=>{const{onChange:r,config:t}=this.props,o=t.measurements.color.colorPicker.thumb.size/2,n=t.measurements.color.colorPicker.thumb.size;let i=0,a=0;i=e.clientX,a=e.clientY;const s=react_dom__WEBPACK_IMPORTED_MODULE_4__.findDOMNode(this);if(s&&s instanceof HTMLElement){const{top:l,left:h,width:d,height:S}=s.getBoundingClientRect();let x=i-h-o,A=a-l-o;x=Math.max(0,Math.min(d-n,x)),A=Math.max(0,Math.min(S-n,A)),r&&r({x,y:A}),this.setState({x,y:A})}};this.onDrag=e=>{this.state.dragging&&this.onPositionChange(e)};this.onDragStop=()=>{this.state.dragging&&this.setState({dragging:!1})};this.state={dragging:!1,x:e.defaultPosition.x,y:e.defaultPosition.y},this.debouncedOnDrag=ne.default(this.onDrag,10)}componentWillUnmount(){this.setState({dragging:!1})}render(){const{surface:e,setInnerRef:r,className:t,children:o}=this.props;return react__WEBPACK_IMPORTED_MODULE_2__.createElement(De,{ref:r,className:t},react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.DraggableCore,{onStart:this.onDragStart,onDrag:this.debouncedOnDrag,onStop:this.onDragStop},e),o)}}ie.defaultProps={defaultPosition:{x:0,y:0}};var P=(0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.aa)("config","active")((0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.Z)(ie));const Ee=styled_components__WEBPACK_IMPORTED_MODULE_3__.css`
  position: absolute;
  top: 3px;
  left: 0;
  width: 100%;
...
`;var k=Ee;const Le=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  ...
  height: 8px;
`;class Ve extends react__WEBPACK_IMPORTED_MODULE_2__.Component{constructor(e){super(e);this.onKnob=({x:e})=>{const{onChange:r,config:t}=this.props,{offsetWidth:o}=this.node,n=o-t.measurements.color.colorPicker.thumb.size,i=e*o/n,a=Math.max(0,Math.min(360,i/o*360));r(a),this.setState({x:e})};this.setPositionFromColor=e=>{const{config:r}=this.props,{offsetWidth:t}=this.node;let o=0;const n=t-r.measurements.color.colorPicker.thumb.size;this.node&&(o=e.toHsv().h*t/360),this.setState({x:o*n/t})};this.nodeRef=r=>{this.node=r},this.state={x:0}}render(){const{x:e}=this.state;return react__WEBPACK_IMPORTED_MODULE_2__.createElement(P,{surface:react__WEBPACK_IMPORTED_MODULE_2__.createElement(Le,null),setInnerRef:this.nodeRef,onChange:this.onKnob},react__WEBPACK_IMPORTED_MODULE_2__.createElement(H,{position:{x:e,y:0}}))}}var se=(0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.aa)("config")((0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.Z)(Ve));const ze=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div.attrs(e=>({style:{background:`linear-gradient(to left, ${e.transparentColor} 0%, ${e.opaqueColor} 100%)`}}))`
  ${k}
  z-index: 1;
...
`;class Ne extends react__WEBPACK_IMPORTED_MODULE_2__.Component{constructor(e){super(e);this.onKnob=({x:e})=>{const{onChange:r,config:t}=this.props,{offsetWidth:o}=this.node,n=o-t.measurements.color.colorPicker.thumb.size,i=e*o/n,a=(o-i)/o,s=Math.round((a+Number.EPSILON)*100)/100,l=Math.min(1,Math.max(0,s));r(l),this.setState({x:e})};this.setPositionFromColor=e=>{const{config:r}=this.props,{offsetWidth:t}=this.node;let o=0;const n=t-r.measurements.color.colorPicker.thumb.size;this.node&&(o=(1-e.toHsv().a)*t),this.setState({x:o*n/t})};this.nodeRef=r=>{this.node=r},this.state={x:0}}render(){const{opaqueColor:e,transparentColor:r,config:t}=this.props,{x:o}=this.state,n=t.assetProvider.getPath("controls","/tiled-background.png");return react__WEBPACK_IMPORTED_MODULE_2__.createElement(P,{surface:react__WEBPACK_IMPORTED_MODULE_2__.createElement(ze,{opaqueColor:e,transparentColor:r}),setInnerRef:this.nodeRef,onChange:this.onKnob},react__WEBPACK_IMPORTED_MODULE_2__.createElement(qe,{url:n}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(H,{position:{x:o,y:0}}))}}var le=(0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.aa)("config")((0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.Z)(Ne));const We=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div.attrs(e=>({style:{backgroundColor:`hsl(${e.hue}, 100%, 50%)`}}))`
  ${k}
  background: linear-gradient(to top, rgb(0, 0, 0), rgba(0, 0, 0, 0)),
   linear-gradient(to right, rgb(255, 255, 255), rgba(255, 255, 255, 0));
  height: ${e=>e.theme.measurements.color.colorPicker.saturationSlider.height}px;
  top: 0px;
`,Ke=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__.default)(P)`
  height: ${e=>e.theme.measurements.color.colorPicker.saturationSlider.height}px;
  margin-top: 0px;
`;class Ue extends react__WEBPACK_IMPORTED_MODULE_2__.Component{constructor(e){super(e);this.setPositionFromColor=e=>{const{config:r}=this.props,t={x:0,y:0};if(this.node){const{s:o,v:n}=e.toHsv(),{offsetWidth:i,offsetHeight:a}=this.node,s=i-r.measurements.color.colorPicker.thumb.size,l=a-r.measurements.color.colorPicker.thumb.size,h=o*i,d=(1-n)*a;t.x=h*s/i,t.y=d*l/a}this.setState({position:t})};this.onChange=({x:e,y:r})=>{const{onChange:t,config:o}=this.props,{offsetHeight:n,offsetWidth:i}=this.node,a=i-o.measurements.color.colorPicker.thumb.size,s=n-o.measurements.color.colorPicker.thumb.size,l=e*i/a,h=r*n/s,d=Math.min(1,Math.max(0,l/i)),S=Math.min(1,Math.max(0,(n-h)/n));t(d,S),this.setState({position:{x:e,y:r}})};this.nodeRef=r=>{this.node=r},this.state={position:{x:0,y:0}}}render(){const{hue:e}=this.props,{position:r}=this.state;return react__WEBPACK_IMPORTED_MODULE_2__.createElement(Ke,{surface:react__WEBPACK_IMPORTED_MODULE_2__.createElement(We,{hue:e}),setInnerRef:this.nodeRef,onChange:this.onChange},react__WEBPACK_IMPORTED_MODULE_2__.createElement(H,{position:r}))}}var ce=(0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.aa)("config")((0,_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.Z)(Ue));const _e=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  position: absolute;
...
`,Xe=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__.default)(se)`
  margin-top: 8px;
`,Ye=(0,styled_components__WEBPACK_IMPORTED_MODULE_3__.default)(le)`
  margin-top: 8px;
...
`,Ze=styled_components__WEBPACK_IMPORTED_MODULE_3__.default.div`
  display: flex;
`;class _ extends react__WEBPACK_IMPORTED_MODULE_2__.Component{constructor(e){super(e);this.node=react__WEBPACK_IMPORTED_MODULE_2__.createRef();this.saturationRef=null;this.hueRef=null;this.opacityRef=null;this.checkId=(e,r,t)=>{let o=e,n=0;for(;o.parentElement&&n<t;)if(o=o.parentElement,n+=1,o.id===r)return!0;return!1};this.handleOutsideClick=e=>{var n;const{onRequestClose:r,onAddSnapshot:t}=this.props,{color:o}=this.state;if((n=this.node.current)==null?void 0:n.contains(e.target))return;this.setState({hexInputValue:o.toHexString()}),r&&r(),t&&t()};this.onChange=e=>{const{onChange:r}=this.props;r({color:e.toRgbArray(),colorString:e.toRgbString()})};this.onHexValueChange=e=>{if(e.match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/i)){const r=new m(e);this.onChange(r),this.setState({color:r,hue:r.toHsl().h}),this.saturationRef.current.setPositionFromColor(r),this.hueRef.current.setPositionFromColor(r)}this.setState({hexInputValue:e})};this.onAlphaChange=e=>{const{color:r}=this.state,t=r.setAlpha(e);this.onChange(t),this.setState({color:t,hexInputValue:t.toHexString()})};this.onHueChange=e=>{const{color:r}=this.state,{s:t,v:o,a:n}=r.toHsv(),i=new m({h:e,s:t,v:o,a:n});this.onChange(i),this.setState({color:i,hexInputValue:i.toHexString(),hue:e})};this.onSaturationBrightnessChange=(e,r)=>{const{color:t,hue:o}=this.state,{a:n}=t.toHsv(),i=new m({h:o,s:e,v:r,a:n});this.onChange(i),this.setState({color:i,hexInputValue:i.toHexString()})};this.onInputChange=e=>r=>{const{color:t}=this.state;if(r.match(/0*([0-9]|[1-8][0-9]|9[0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])/g)||!r.trim()){const o=t.toRgb();o[e]=parseInt(r,10)||0;const n=new m(o);this.onChange(n),this.saturationRef.current.setPositionFromColor(n),this.hueRef.current.setPositionFromColor(n),this.setState({color:n,hexInputValue:n.toHexString(),hue:n.toHsl().h})}};const{color:r}=this.props,t=new m(r);this.state={color:t,hue:t.toHsl().h,hexInputValue:t.toHexString()},this.saturationRef=react__WEBPACK_IMPORTED_MODULE_2__.createRef(),this.hueRef=react__WEBPACK_IMPORTED_MODULE_2__.createRef(),this.opacityRef=react__WEBPACK_IMPORTED_MODULE_2__.createRef()}componentDidMount(){const{color:e}=this.state;document.addEventListener("mousedown",this.handleOutsideClick,!1),document.addEventListener("touchstart",this.handleOutsideClick,!1),document.addEventListener("keydown",this.handleOutsideClick,!1),this.saturationRef.current.setPositionFromColor(e),this.hueRef.current.setPositionFromColor(e),this.opacityRef.current.setPositionFromColor(e)}componentDidUpdate(e){const{color:r,show:t}=this.props;if(t&&!e.show){const o=new m(r);this.saturationRef.current.setPositionFromColor(o),this.hueRef.current.setPositionFromColor(o),this.opacityRef.current.setPositionFromColor(o),this.setState({color:o,hue:o.toHsl().h,hexInputValue:o.toHexString()})}}componentWillUnmount(){document.removeEventListener("mousedown",this.handleOutsideClick,!1),document.removeEventListener("touchstart",this.handleOutsideClick,!1),document.removeEventListener("keydown",this.handleOutsideClick,!1)}render(){const{show:e,showArrow:r,direction:t,arrowOffset:o,topOffset:n,leftOffset:i,labelHex:a,labelR:s,labelG:l,labelB:h,labelSliderHue:d,labelSliderOpacity:S}=this.props,{color:x,hexInputValue:A,hue:de}=this.state,{r:pe,g:me,b:ge}=x.toRgb(),be=x.clone().setAlpha(1).toRgbString(),xe=x.clone().setAlpha(0).toRgbString();return react__WEBPACK_IMPORTED_MODULE_2__.createElement("div",{ref:this.node},react__WEBPACK_IMPORTED_MODULE_2__.createElement(_e,{show:e,direction:t,leftOffset:i,topOffset:n},react__WEBPACK_IMPORTED_MODULE_2__.createElement(fe,{direction:t},r&&react__WEBPACK_IMPORTED_MODULE_2__.createElement(Q,{direction:t,arrowOffset:o}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(ce,{ref:this.saturationRef,hue:de,onChange:this.onSaturationBrightnessChange}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Spacer,{count:2}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Label,{label:d}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Xe,{ref:this.hueRef,onChange:this.onHueChange}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Spacer,{count:2}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.X.Input.Label,{label:S}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Ye,{ref:this.opacityRef,opaqueColor:be,transparentColor:xe,onChange:this.onAlphaChange}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Je,null,react__WEBPACK_IMPORTED_MODULE_2__.createElement(re,{value:A,label:a,onChange:this.onHexValueChange}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(Ze,null,react__WEBPACK_IMPORTED_MODULE_2__.createElement(F,{value:pe,label:s,onChange:this.onInputChange("r")}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(F,{value:me,label:l,onChange:this.onInputChange("g")}),react__WEBPACK_IMPORTED_MODULE_2__.createElement(F,{value:ge,label:h,onChange:this.onInputChange("b")}))))))}}_.defaultProps={direction:"bottom",showArrow:!0};fe.defaultProps={theme:_chunk_UODY7UPN_js__WEBPACK_IMPORTED_MODULE_0__.v};
