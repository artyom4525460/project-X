<div x-data="{ open : true, progress: false}" x-show="open" class="fixed z-10 inset-0 overflow-y-auto">
          ...
          <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
                Register this store in Cander
              </h3>
              <div class="mt-2">
                <p class="text-sm leading-5 text-gray-500">
                  To use this application you need a Cander account.
                  Please click the "Create" button and the account will be created.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
            <button @click="progress = true;
                  axios.post('cander/stores/register')
              ...
              <span x-show="progress" class="pr-2"> @include('partials.spinner') </span> Create
            </button>
          </span>
